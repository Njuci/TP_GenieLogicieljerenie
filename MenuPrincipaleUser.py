...
from GestNotesTituFront import GestNotesFrontend2
...
class MenuPrincipaleUserFrontend:
    ver=0
    def __init__(self,Curseur,con,compte,IDTitu,nom):
        ...
        #Creation des conteneurs d'ecran
        ...
        Menu4=GestNotesFrontend2(self.Curseur,self.GestNotes,self.compte,self.IdTitulaire,self.nom,self.Connexion)
        ...
        self.GestNotes_btn.place(x=20,y=80, width=200,height=40)
        self.Exit_btn= Button(self.MenuContainer,bg='white',text='Déconnexion',fg='#6666b9',relief="groove", font = "Arial 12 ")
        self.Exit_btn.place(x=20,y=140, width=200,height=40)
        self.ver=0
